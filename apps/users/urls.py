...
from apps.users.views import UserAPIViewSet, UserRegisterAPIView, UserRetrieveUpdateDestroyAPIView, UsersAnotherAPIView
...
urlpatterns = [
    ...
    path('users-another/', UsersAnotherAPIView.as_view(), name = "api_users_another"),
    #auth
